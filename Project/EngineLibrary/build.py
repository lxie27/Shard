...
if platform.system()=="Linux":
    ...
    INCLUDE_DIR="-I./include/SDL2 -I./include"
    EXECUTABLE="./GameBuild/Platformer/Platformer"
    LIBRARIES="-L./lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_mixer -lSDL2_image -lSDL2_ttf -lSDL2 -mwindows"
# (2)=================== Platform specific configuration ===================== #
